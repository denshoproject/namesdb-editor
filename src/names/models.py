...
class Person(models.Model):
    ...
    citizenship                   = models.CharField(max_length=255,          verbose_name='Country of Citizenship',    help_text='Country of citizenship')
    ...
    preexclusion_residence_city   = models.CharField(max_length=255, blank=True, null=True, verbose_name='Pre-exclusion City',        help_text='Last city of residence prior to exclusion')
    preexclusion_residence_state  = models.CharField(max_length=255, blank=True, null=True, verbose_name='Pre-exclusion State',       help_text='Last state of residence prior to exclusion')
    postexclusion_residence_city  = models.CharField(max_length=255, blank=True, null=True, verbose_name='Post-detention City',       help_text='City of residence immediately following detention')
    postexclusion_residence_state = models.CharField(max_length=255, blank=True, null=True, verbose_name='Post-detention State',      help_text='State of residence immediately following detention')
...
class FarRecord(models.Model):
    ...
    citizenship             = models.CharField(max_length=255, blank=1, verbose_name='Citizenship Status', help_text='Citizenship status')
